...
export type R2BucketLike = { put(key: string, value: ArrayBuffer, options?: Record<string, unknown>): Promise<unknown>; get?(key: string): Promise<R2ObjectLike | null>; delete?(key: string): Promise<void>; createMultipartUpload?: unknown };
