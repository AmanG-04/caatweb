...
const projects: readonly ProjectReference[] = [
  {
    ...
    system: "20,000 LPD solar water-heating system",
    location: "Faridabad",
    date: "Jun 2026",
    scope: "Successful completion of a large-scale solar water-heating project for a healthcare facility, including supply of 54 FPC solar water-heater panels, repair of the old system, and structural reinforcement for safety and long-term performance.",
    equipment: "54 FPC solar water-heater panels · structural reinforcement · system repair and handover",
  ...
  {
    client: "Abhinandan Jan Kalyan Charitable Hospital",
    category: "Rooftop solar",
    system: "90 kWp rooftop solar power system",
    location: "Karkardooma, Delhi",
    date: "Apr 2025",
    scope: "90 kWp rooftop solar power system for a charitable healthcare facility and cancer hospital, with a focus on maximizing energy generation and reducing electricity costs.",
